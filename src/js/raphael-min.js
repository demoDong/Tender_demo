! function t(e, r) {
	...
	return function(t) {
		...
		i = [r(2)], n = function(t) {
			...
			function v() {
				return this.x + I + this.y + I + this.width + " ¡Á " + this.height
			}
			...
			var Pt = function(t) {
					if (e.vml) {
						...
						l.title = "Rapha?l Colour Picker", l.style.display = "none", A.doc.body.appendChild(l), Pt = n(function(t) {
			...
			e.getRGB = n(function(t) {
				...
				return u ? (u[2] && (s = ut(u[2].substring(5), 16), n = ut(u[2].substring(3, 5), 16), i = ut(u[2].substring(1, 3), 16)), u[3] && (s = ut((l = u[3].charAt(3)) + l, 16), n = ut((l = u[3].charAt(2)) + l, 16), i = ut((l = u[3].charAt(1)) + l, 16)), u[4] && (h = u[4][q](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), "rgba" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100)), u[5] ? (h = u[5][q](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), ("deg" == h[0].slice(-3) || "¡ã" == h[0].slice(-1)) && (i /= 360), "hsba" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100), e.hsb2rgb(i, n, s, o)) : u[6] ? (h = u[6][q](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), ("deg" == h[0].slice(-3) || "¡ã" == h[0].slice(-1)) && (i /= 360), "hsla" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100), e.hsl2rgb(i, n, s, o)) : (u = {
					r: i,
					g: n,
					b: s,
					toString: a
					...
					for (m = 0; b > m; m++)
						if (l = a[m], "zIndex" in l)
							if (l.zIndex == h[s]) {
								...
								do
									if (s++, l = g[h[s]], l && x.push(l.apply(e, n)), f) break;
								while (l)
							} else g[l.zIndex] = l;
		...
		i = [r(1)], n = function(t) {
			if (!t || t.svg) {
				...
				A.prototype = E, E.constructor = A, t._engine.path = function(t, e) {
					...
					this.bottom = this.top = null, (this.desc = x("desc")).appendChild(t._g.doc.createTextNode("Created with Rapha?l " + t.version)), e.appendChild(this.desc), e.appendChild(this.defs = x("defs"))
			...
			if (!t || t.vml) {
				...
				var S = function(t, e, i) {
					...
					T = function(n, l) {
						...
						if ("arrow-start" in l && S(m, l["arrow-start"]), "arrow-end" in l && S(m, l["arrow-end"], 1), null != l.opacity || null != l["stroke-width"] || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
